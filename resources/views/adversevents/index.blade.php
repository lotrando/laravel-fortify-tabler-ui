          ...
          <div class="modal-body">
            ...
            <div class="row">
              ...
              <div class="col-6 col-lg-2 pb-1">
                ...
                <input class="form-control" id="datum_cas" name="datum_cas" type="date" value="{{ date('Y-m-d') ?? old('date') }}"
                       placeholder="{{ __('Dnešní datum') }}" onkeydown="return false">
              </div>
              <div class="col-6 col-lg-2 pb-1">
                <label class="form-label">{{ __('Čas') }}</label>
                <input class="form-control" id="cas" name="cas" type="time" value="{{ date('H:i') ?? old('time') }}"
                       placeholder="{{ __('Aktuální čas') }}">
              </div>
            </div>
            <div class="row">
              <div class="col-12 col-lg-4 pb-1">
