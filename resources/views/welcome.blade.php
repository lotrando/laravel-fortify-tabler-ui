            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" data-bs-auto-close="outside" href="#navbar-base" role="button" aria-expanded="false">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
                  ...
                  <svg class="icon icon-tabler icon-tabler-info-circle" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="2"
                       stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    <circle cx="12" cy="12" r="9"></circle>
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item" href="{{ url('http://akordapp/SISAkord/Login.aspx?ReturnUrl=%2fSISAkord%2f') }}" target="_blank">
                  <span class="nav-link-icon d-md-none d-lg-inline-block">
                    ...
                    <svg class="icon icon-tabler icon-tabler-album" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="2"
                         stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                      <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
        ...
        <div class="row">
          ...
          <div class="col-12 col-md-6 col-lg-5">
            ...
            <div class="card mb-3">
              ...
              <div class="card-body">
                <div class="d-flex-col align-items-center">
                  <table class="table-bordered table-hover table" style="width: 100%; height: 90px;">
                    <tbody>
                      <tr>
      ...
      <div class="container-fluid">
        <div class="row align-items-center flex-row-reverse text-center">
          <div class="col-lg-auto ms-lg-auto">
            <ul class="list-inline list-inline-dots mb-0">
              <li class="list-inline-item">
                <a class="link-secondary" href="mailto:klika@khn.cz" target="_blank" rel="noopener">
          ...
          <div class="col-12 col-lg-auto mt-lg-0 mt-3">
            <ul class="list-inline list-inline-dots mb-0">
              <li class="list-inline-item">
                &copy; {{ now()->year }} - <a class="link-secondary" href="https://www.khn.cz" target="_blank" rel="noopener">KHN a.s.</a> - všechna práva vyhrazena
              </li>
            </ul>
          </div>
        </div>
