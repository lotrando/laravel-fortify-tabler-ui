...
class AdverseventController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->merge(['status' => 'Rozpracováno']);

        $event = Adversevent::create($request->all());
        ...
        $rules = [
            ...
            'datum'                 => $request->datum,
            'jmeno_lekare'          => $request->vysetreni,
            ...
            'resitel1'              => $request->resitel1,
            'vyjadreni1'            => $request->vyjadreni1,
            'resitel2'              => $request->resitel2,
            'vyjadreni2'            => $request->vyjadreni2
        ];
